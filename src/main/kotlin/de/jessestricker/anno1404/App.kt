...
import de.jessestricker.anno1404.data.Assets
...
private val ASSETS_XML_FILE = DATA1_FILE / "data/config/game/assets.xml"
...
fun main() {
    ...
    val assets = Assets.parse(ASSETS_XML_FILE, properties)
    println(assets)
